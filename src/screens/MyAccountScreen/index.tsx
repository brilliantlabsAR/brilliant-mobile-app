...
import { mainUser, blackCamera, smallUser, menuBluetooth, menuDeviceFrame, liveStreaming, menuLicence, menuData, menuHelp } from "../../assets";
                ...
                <ScrollView style={styles.firstScrollView}>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                this.props.navigation.navigate('ProfileUpdateScreen')}>
                            <Image
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.menuBox}
                            onPress={() =>
                                this.props.navigation.navigate('RtmpStreamScreen')
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.menuBox}
                            onPress={() =>
                                this.props.navigation.navigate("SlugScreen", {
                                    pageNo: "1"
                                })}>
                            <Image
                                style={styles.menuIcon}
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                ...
                                //     pageNo: "3"
                                // })
                                this.props.navigation.navigate('RtmpStreamerScreen')
                            }>
                            <Image
                                style={styles.menuIcon}
                                source={menuHelp}
