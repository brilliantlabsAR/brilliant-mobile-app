        ...
        <SafeAreaView style={styles.bodyContainer}>
            ...
            <ScrollView style={styles.scrollContainer}>
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.signupdescText}>{'Please enter your personal details below'}</Text>
                ...
                <View style={styles.alreadyaccountView}>
                    <Text style={styles.alreadyaccountText}>{'Already have an account? '}
                        <Text style={{ textDecorationLine: 'underline',}}
                            onPress={() => console.log('loginscreen')}>Login</Text>
                        </Text>
                </View>
                </View>
                </View>    
                <View style={styles.termsView}>
                    <Text style={styles.termsText}>{'by signing up you agree with our '}
                        <Text style={{textDecorationLine: 'underline',}} onPress={() => 'Coming soon'}>Terms and Conditions.</Text>
                        </Text>
                </View>
